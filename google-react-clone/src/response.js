export const data = {
  ...
  searchInformation: {
    ...
    totalResults: '345000000',
    formattedTotalResults: '345,000,000',
  },
  items: [
    {
    ...
    },
    {
      ...
      snippet:
        "1 hour ago ... Tesla, Inc. is an American electric vehicle and clean energy company based in \nPalo Alto, California. Tesla's current products include electric ...",
      htmlSnippet:
        '1 hour ago \u003cb\u003e...\u003c/b\u003e \u003cb\u003eTesla\u003c/b\u003e, Inc. is an American electric vehicle and clean energy company based in \u003cbr\u003e\nPalo Alto, California. \u003cb\u003eTesla&#39;s\u003c/b\u003e current products include electric&nbsp;...',
...
// export const data = JSON.parse(JSON.stringify(response));
